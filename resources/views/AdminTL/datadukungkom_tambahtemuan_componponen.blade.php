                                    ...
                                    <td class="temuan-content-cell">
                                        <div class="temuan-field-group">
                                            <div class="temuan-field-row">
                                                ...
                                                <input type="text" class="form-control" name="tipeB[{{ $key }}][kode_temuan]" value="{{ $item->kode_temuan ?? '' }}" required>
                                            </div>
                                            <div class="temuan-field-row">
                                                <label>Nama Temuan</label>
                                                <textarea class="form-control" name="tipeB[{{ $key }}][nama_temuan]" required>{{ $item->nama_temuan ?? '' }}</textarea>
                                            </div>
                                            <div class="temuan-field-row">
                                                <small class="text-muted">
                                                    <i class="fa-solid fa-info-circle"></i>
                                                    Level Parent - Hanya berisi informasi temuan utama.
                                                    Kode Rekomendasi dan detail lainnya diisi di level rekomendasi (sub item).
                                                </small>
                                            </div>
                                        </div>
                                    </td>
                                        ...
                                        <div class="temuan-field-group">
                                            ...
                                            <div class="temuan-field-row">
                                                <small class="text-muted">
                                                    <i class="fa-solid fa-info-circle"></i>
                                                    Level Parent - Hanya berisi informasi temuan utama.
                                                    Tambahkan sub item untuk memasukkan Kode Rekomendasi dan detail lainnya.
                                                </small>
                                            </div>
                                        </div>
                                    </td>
            ...
            <div class="temuan-hierarchy-item temuan-level-0" data-level="0" data-index="${index}">
                <table class="temuan-hierarchy-table">
                    <tr class="main-row">
                        ...
                        <td class="temuan-action-cell">
                            <button type="button" data-level1="${index}" class="btn btn-purple btn-sm temuan-add-sub" title="Tambah Sub Rekomendasi">
                                <i class="fas fa-indent"></i>
                            </button>
                            <button type="button" class="btn btn-danger btn-sm temuan-remove-item" title="Hapus Temuan">
                                <i class="fa-solid fa-minus"></i>
